...
function drawChart(mode) {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`#${chartMode}`).attr('aria-label', arialabel)
  const options = {
...
function loadSelect() {
  chartOptions.map((option) => {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#selectHeroChart').append(`<option value="${option}">${option}</option>`)
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#selectComicChart').append(`<option value="${option}">${option}</option>`)
  })
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#selectHeroChart').change(() => {
    type = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#selectHeroChart').val()
    drawChart('superheroes')
  })
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#selectComicChart').change(() => {
    type = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#selectComicChart').val()
    drawChart('comics')
  })
}
