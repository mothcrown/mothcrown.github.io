...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jquery_simplePagination__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__images_grey_arrow_png__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__images_grey_arrow_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__images_grey_arrow_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__images_spinner_gif__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__images_spinner_gif___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__images_spinner_gif__);
...
function activateDescriptionToggle(descriptionMode, descriptionToggleMode, description) {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`#${descriptionToggleMode}`).click(() => {
    if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(`#${descriptionToggleMode}`).text() === '(Ver más)') {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(descriptionMode).text(description)
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`#${descriptionToggleMode}`).text('(...)')
    } else {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(descriptionMode).text(`${description.substring(0, 20)}... `)
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`#${descriptionToggleMode}`).text('(Ver más)')
    }
  })
}
...
function addDescriptionToggle(mode, description) {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`<span id="${descriptionToggleMode}">(Ver más)</span>`).insertAfter(descriptionMode)
...
function refreshInfo(mode) {
  const index = +__WEBPACK_IMPORTED_MODULE_0_jquery___default()(`.${mode}.principal`).attr('id').substr(9)
  let description
  if (mode === 'superheroes') {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#idsuper').text(superheroes[index].id)
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#name').text(superheroes[index].name)
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#comics').text(superheroes[index].comics.available)
    description = (superheroes[index].description !== '') ? superheroes[index].description : 'No disponible'
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#descriptionsuper').text(description)
    if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#descriptionToggleSuper') !== undefined) {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#descriptionToggleSuper').remove()
    }
    if (description !== 'No disponible') {
      addDescriptionToggle(mode, description)
    }
  } else {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#comicid').text(comics[index].id)
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#title').text(comics[index].title)
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#issue').text(comics[index].issueNumber)
    description = (comics[index].description !== null) ? comics[index].description : 'No disponible'
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#descriptioncomic').text(description)
    if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#descriptionToggleComic') !== undefined) {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#descriptionToggleComic').remove()
    }
    if (description !== 'No disponible') {
      addDescriptionToggle(mode, description)
    }
...
function moveCarouselLeft(mode) {
  let index = +__WEBPACK_IMPORTED_MODULE_0_jquery___default()(`.${mode}.third.left`).attr('id').substr(9)
  index -= 1
...
function deactivateArrows() {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#leftarrowSuper').off('click')
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#rightarrowSuper').off('click')
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#leftarrowComic').off('click')
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#rightarrowComic').off('click')
}
...
function activateArrows() {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#leftarrowSuper').click(() => {
    moveCarouselLeft('superheroes')
  })
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#rightarrowSuper').click(() => {
    moveCarouselRight('superheroes')
  })
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#leftarrowComic').click(() => {
    moveCarouselLeft('comics')
  })
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#rightarrowComic').click(() => {
...
function activateCarousels(mode) {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`.left.${mode}`).click(() => {
    moveCarouselLeft(mode)
  })
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`.right.${mode}`).click(() => {
...
function vote(mode) {
  ...
  if (Storage !== void(0)) {
    ...
    newVote.telefono = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#txtTfno').val()
    newVote.voto = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#nameForm').text()
    if (mode === 'superheroes') {
...
function openDialog(mode) {
  ...
  const voteName = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(getField).text()
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#nameForm').text(voteName)
  activateButtons(mode)
}


function activatePrincipal(mode) {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(`.principal.${mode}`).click(() => {
    openDialog(mode)
  })
}
...
function moveCarousel(mode, index) {
  ...
  const leftarrow = `<div id="${leftArrowId}" class="arrow" aria-label="Mueve selección a la izquierda"><img src="${__WEBPACK_IMPORTED_MODULE_2__images_grey_arrow_png___default.a}" aria-labelledby="leftarrow" alt="Flecha izquierda"></div>`
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(leftarrow).appendTo(carouselMode)
  let j = 0
  do {
    let carouselElement
    if (mode === 'superheroes') {
      ...
      if (carouselClasses[j] !== 'principal') {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#currentHero').text(`${i + 1}/100`)
      }
    } else {
      ...
      if (carouselClasses[j] !== 'principal') {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#currentComic').text(`${i + 1}/100`)
      }
    }

    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(carouselElement).appendTo(carouselMode)
    i += 1
    if (i === petitionLength) {
      i = 0
    }
  ...
  const rightarrow = `<div id="${rightArrowId}" class="arrow" aria-label="Mueve selección a la derecha"><img src="${__WEBPACK_IMPORTED_MODULE_2__images_grey_arrow_png___default.a}" aria-labelledby="rightarrow" alt="Flecha derecha"></div>`
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(rightarrow).appendTo(carouselMode)
...
function loadVotes() {
  if (Storage !== void(0)) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.popup').find('p').first().text('¡Voto no realizado!')
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.popup').find('p').last().text('No se ha podido guardar el voto, lo sentimos.')
  }
}
...
function loadStuff(mode) {
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(spinnerMode).append(`<img src="${__WEBPACK_IMPORTED_MODULE_3__images_spinner_gif___default.a}"></img>`)
  __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.getJSON(queryFor(mode), { limit: 100, apikey: publicKey }).done(function (response) {
    ...
    moveCarousel(mode, 0)
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(spinnerMode).empty()
  })
}
...
function loadPaginators() {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#paginatorSuperheroes').pagination({
    items: 100,
    itemsOnPage: 10,
  ...
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#paginatorComics').pagination({
    items: 100,
    itemsOnPage: 10,
    cssStyle: 'light-theme',
    onPageClick: (pageNum) => {
